...
namespace Procurement
{
    public partial class FrmBOM : Form
    {
       ...
       private FrmBOM()
        ...
        {
            decimal quantity = ReturnAppropriateValue(dataGridView2.Rows[e.RowIndex].Cells["Qty"].Value);
            decimal rate = ReturnAppropriateValue(dataGridView2.Rows[e.RowIndex].Cells["UnitCost"].Value);
            ...
            //dataGridView2.Rows[e.RowIndex].Cells["ExtCost"].Value = price.ToString();
        ...
        {
            decimal quantity = ReturnAppropriateValue(dataGridView3.Rows[e.RowIndex].Cells["Qty"].Value);
            decimal rate = ReturnAppropriateValue(dataGridView3.Rows[e.RowIndex].Cells["UnitCost"].Value);
