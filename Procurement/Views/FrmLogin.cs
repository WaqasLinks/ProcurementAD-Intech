...
namespace Procurement
{
    public partial class FrmLogin : Form
    {
        ...
        private void Login()
        {
            ...
            string UserPrincipalName = "administrator@tenf.loc";//System.DirectoryServices.AccountManagement.UserPrincipal.Current.UserPrincipalName;
            bool IsuserActive = true;//System.DirectoryServices.AccountManagement.UserPrincipal.Current.Enabled.Value;
